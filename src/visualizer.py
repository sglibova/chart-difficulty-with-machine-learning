...
def distribution(df, feature): 
    '''Prints a Seaborn distribution graph with KDE given a dataframe and selected feature'''
...
def scatter_correlation(df, feature1, feature2 = 'rating'):
    '''Prints a Seaborn scatter plot to visualize correlation, given a dataframe and at least one feature (default y value is rating)'''
    fig, ax = plt.subplots(figsize = (10, 8))
...
def box_plot(df, feature1, feature2 = 'step_count'):
    '''Prints a Seaborn box plot to visualize feature spread given a dataframe and at least one feature (default y is step count)'''
    fig, ax = plt.subplots(figsize = (10,8))
...
def plot_resids(model, x_train, y_true):
    '''Predicts values and plots a residual plot, given a dataframe and two valid array/series inputs of x values and true y values'''
